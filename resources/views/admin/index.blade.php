    ...
    <div class="page-container">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>ADD STATE
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li>
                            <a aria-expanded="true" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="fa fa-align-left">
                                     Logout</a></li>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright 2019. All right reserved.by hierME</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
