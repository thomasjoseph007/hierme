...
<!-- index.html  [XR&CO'2014], 09:16:11 GMT -->
<head>
		...
		<div>
			<div >
                ...
                <ul>
                    ...
                    <li><a href="{{ route('register') }}"><i class="la la-key"></i> Sign Up</a></li>
					<li><a href="{{ route('login') }}"><i class="la la-external-link-square"></i> Login</a></li>
				</ul>
			</div><!-- Btn Extras -->
	...
	<section>
		<div class="block no-padding">
			<div class="container fluid">
				<div class="row">
					<div class="col-lg-6">
						<div data-velocity="-.1" style="background: url(images/resource/parallax1.jpg) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible layer blackish"></div><!-- PARALLAX BACKGROUND IMAGE -->
						<div class="who-am">
							...
							<a href="#" title="">Browse Jobs</a>
						</div>
					</div>
					<div class="col-lg-6">
						<div data-velocity="-.1" style="background: url(images/resource/parallax2.jpg) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible layer color green2"></div><!-- PARALLAX BACKGROUND IMAGE -->
						<div class="who-am flip">
							<h3>I WANT TO HIRE!</h3>
							<p>One of our One of our jobs has some kind of flexibility jobs has some kind of flexibility option such as telecommuting, a part-time schedule or a flexible or flextime.</p>
							<a href="#" title="">Post new job</a>
						</div>
					</div>
				</div>
			</div>	
					...
					<div class="col-lg-3 column">
						<div class="widget">
							<div class="about_widget">
								...
								<span><a href="https://grandetest.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bad3d4dcd5fad0d5d8d2cfd4ce94d9d5d7">[email&#160;protected]</a></span>
								<div class="social">
	...
	<div class="account-popup">
		...
		<form method="POST" action="{{ route('register') }}">
			...
			<div class="clfield">
					 ...
					 <input type="radio" name="utype" id="232"  value="freelancer" {{ (old('type') == 'freelancer') ? 'checked' : '' }} checked/>
						<label for="232">FREELANCER</label>
					
						<input type="radio" name="utype" id="wwqe" value="employer" {{ (old('type') == 'employer') ? 'checked' : '' }}/>
						<label for="wwqe">EMPLOYER</label><br>
...
<!-- index.html  [XR&CO'2014], 09:17:00 GMT -->
</html>
